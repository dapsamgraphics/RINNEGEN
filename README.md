Script ini dibuat untuk mempermudah proses pembuatan akun secara otomatis. Script ini akan menghasilkan username, email, serta menyimpan informasi akun dalam format `.txt`. 
